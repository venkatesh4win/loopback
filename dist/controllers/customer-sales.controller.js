...
exports.CustomerSalesController = void 0;
const tslib_1 = require("tslib");
const repository_1 = require("@loopback/repository");
const rest_1 = require("@loopback/rest");
const models_1 = require("../models");
const repositories_1 = require("../repositories");
let CustomerSalesController = class CustomerSalesController {
...
tslib_1.__decorate([
    (0, rest_1.get)('/customers/{id}/sales', {
        responses: {
            '200': {
...
], CustomerSalesController.prototype, "find", null);
tslib_1.__decorate([
    (0, rest_1.post)('/customers/{id}/sales', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], CustomerSalesController.prototype, "create", null);
tslib_1.__decorate([
    (0, rest_1.patch)('/customers/{id}/sales', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], CustomerSalesController.prototype, "patch", null);
tslib_1.__decorate([
    (0, rest_1.del)('/customers/{id}/sales', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:paramtypes", [String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], CustomerSalesController.prototype, "delete", null);
CustomerSalesController = tslib_1.__decorate([
...
exports.CustomerSalesController = CustomerSalesController;
//# sourceMappingURL=customer-sales.controller.js.map